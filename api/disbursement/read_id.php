...
$id=$_GET['id'];
$db = new Database;
$sql = "select * from disbursement where confirm=1 and id=".$id;
$db->query($sql);
$disbursement = array();
...
while ($row = $db->fetch_assoc()) {
    $db2 = new Database;
    $sql2 = "select * from user where id=".$row['user_id_conf'];
    $db2->query($sql2);
    ...
    $db1 = new Database;
    $sql1 = "select * from category where id=".$row3['cateid'];
    $db1->query($sql1);
